...
const AdminDashboard = () => {
  ...
  // Navigation items
  const navItems = [
    // keep 'users' internal-only (no route) to avoid conflicting with dashboard root
    { id: 'users', label: 'Registered Users', icon: 'fa-users', href: null },
  ...
  useEffect(() => {
    if (!pathname) return;
    const found = navItems.find((it) => it.href && pathname.startsWith(it.href));
  ...
  const renderContent = () => {
    switch (activeSection) {
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>emily.r@oxford.ac.uk</td>
                    <td>Oxford University</td>
                    <td>Jan 10, 2026</td>
                    <td><span className="badge pending">Pending</span></td>
                  </tr>
                  <tr>
                    <td>Prof. Michael Kim</td>
                    <td>m.kim@nus.edu.sg</td>
      ...
      case 'articles':
        return (
          <div className="section-content">
            <h2><i className="fas fa-file-alt"></i> Submitted Articles</h2>
            <p>Review and manage all article submissions.</p>
            <div className="table-container">
              <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Dr. Sarah Chen</td>
                    <td>Jan 18, 2026</td>
                    <td><span className="badge pending">Under Review</span></td>
                    <td><button className="action-link">Review</button></td>
                  </tr>
                  <tr>
                    <td>Neural Network Optimization</td>
                    <td>Prof. James Wilson</td>
                    <td>Jan 16, 2026</td>
                    <td><span className="badge active">Accepted</span></td>
                  ...
                  <tr>
                    ...
                    <td>Dr. Emily Rodriguez</td>
                    <td>Jan 14, 2026</td>
                    <td><span className="badge inactive">Rejected</span></td>
                    <td><button className="action-link">View</button></td>
                  </tr>
                  <tr>
      ...
      case 'create-volume':
        return (
          <div className="section-content form-section">
            <h2><i className="fas fa-book"></i> Create New Volume</h2>
            <p>Add a new volume to the journal archive.</p>
            <form className="admin-form" onSubmit={(e) => e.preventDefault()}>
              <div className="form-group">
                <label htmlFor="volumeNumber">Volume Number</label>
                <input type="text" id="volumeNumber" placeholder="e.g. 15" />
              </div>
              <div className="form-group">
                <label htmlFor="volumeYear">Year</label>
                <input type="text" id="volumeYear" placeholder="e.g. 2026" />
              </div>
              <div className="form-group">
                <label htmlFor="volumeDescription">Description</label>
                <textarea id="volumeDescription" rows="3" placeholder="Brief description of this volume..."></textarea>
              </div>
              <button type="submit" className="submit-btn">
                <i className="fas fa-plus"></i> Create Volume
              </button>
            </form>
          </div>
        );
      ...
      case 'add-article':
        return (
          <div className="section-content form-section">
            <h2><i className="fas fa-plus-circle"></i> Add New Article</h2>
            <p>Manually add a new article to the journal.</p>
            <form className="admin-form" onSubmit={(e) => e.preventDefault()}>
              <div className="form-group">
              ...
              <div className="form-group">
                <label htmlFor="articleAuthors">Authors</label>
                <input type="text" id="articleAuthors" placeholder="e.g. John Doe, Jane Smith" />
              </div>
              <div className="form-group">
                <label htmlFor="articleVolume">Volume & Issue</label>
                <select id="articleVolume">
                  <option value="">— Select Volume & Issue —</option>
                  <option value="15-2">Volume 15, Issue 2</option>
                  <option value="15-1">Volume 15, Issue 1</option>
                  <option value="14-4">Volume 14, Issue 4</option>
                </select>
              </div>
              <div className="form-group">
                <label htmlFor="articleAbstract">Abstract</label>
                <textarea id="articleAbstract" rows="4" placeholder="Enter article abstract..."></textarea>
              </div>
              <div className="form-group">
                <label htmlFor="articleFile">Article PDF</label>
                <input type="file" id="articleFile" accept=".pdf" />
              </div>
              <button type="submit" className="submit-btn">
                <i className="fas fa-upload"></i> Add Article
              </button>
            </form>
          </div>
        );
        ...
        return (
          <div className="section-content form-section">
            ...
            <form className="admin-form" onSubmit={(e) => e.preventDefault()}>
              ...
              <button type="submit" className="submit-btn">
                <i className="fas fa-plus"></i> Add Editor
              </button>
            </form>
          </div>
        );
  ...
  return (
    <>
      <style>{`
        /* ---- Scoped styles for AdminDashboard ---- */
        .admin-dashboard * {
          margin: 0;
          padding: 0;
          ...
          <nav>
            {navItems.map((item) => (
              item.href ? (
                <Link key={item.id} href={item.href}>
                  <button
                    className={(activeSection === item.id || (pathname && pathname.startsWith(item.href))) ? 'active' : ''}
                  >
        ...
        <main className="main-content">
          <div className="top-bar">
            <div className="page-title">
              Dashboard <span>/ {activeSection === 'dashboard' ? 'Overview' : navItems.find(i => i.id === activeSection)?.label || ''}</span>
            </div>
