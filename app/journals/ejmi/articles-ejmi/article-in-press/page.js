...
export default function ArticlesInPressEjmiPage() {
  ...
  // Array of EJMI "Article in Press" articles based on the screenshot
  const articlesData = [
    {
      id: 1,
      type: "Original Article",
      journal: "Article In Press, European Journal of Multidisciplinary Insights (EJMI)",
      volume: "1",
      issue: "1",
      title: "Determinants of Choice of Finance by Coffee Farmers in Machakos County, Kenya",
      author: "P. Songa, John Cheluget, S. Sandhya, J. Satpathy*"
    },
    {
      id: 2,
      type: "Review",
      ...
      volume: "1",
      issue: "1",
      title: "Challenges and Opportunities in Cross-Disciplinary Research in Financial Systems and Banking Sector of Ethiopia",
    ...
    },
    {
      ...
      volume: "1",
      issue: "1",
      title: "Navigating the Legal Labyrinth: The Impact of Cross-Border Data Flow and Cybersecurity on Global Business Operations and International Cooperation",
      author: "Avijit Silawat"
    },
    {
      id: 4,
      type: "Review",
      ...
      volume: "1",
      issue: "1",
      title: "Redefining the Workplace: The Intersection of AI and Labor Economics in India and Global Economies",
      author: "Harjeet Kaur"
    }
  ];
