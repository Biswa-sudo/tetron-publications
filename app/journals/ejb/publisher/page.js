  ...
  return (
    <>
      ...
      <section className="container my-5">
        ...
        <ul className="small">
          <li>
            <strong>European Journal of Multidisciplinary Insights (EJMI)</strong>
          </li>
          <li>
            <strong>European Journal of Biosciences (EJB)</strong>
          </li>
          <li>
            <strong>
        ...
        <h5 className="fw-semibold text-primary mt-4">
          Commitment to Authors and Readers
        </h5>
        ...
        <p className="small">
          ...
          publishing their work with us and are dedicated to meeting their
          needs with the highest scientific and ethical standards.
        </p>
        ...
        <p className="small">Key practices include:</p>
        ...
        <p className="small">
          Tetron Publications remains committed to supporting researchers at
          all stages of their careers and to fostering a global exchange of
